...
@section('title', 'Laporan Pengeluaran - ' . config('app.name'))
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <form method="GET" action="{{ route('laporan.pengeluaran') }}" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <!-- Jenis Pengeluaran -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Jenis Pengeluaran</label>
            ...
            <div class="text-sm text-gray-600">
                Menampilkan <span class="font-semibold text-gray-900">{{ number_format($pengeluaran->count()) }}</span> data pengeluaran
            </div>
        </form>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
        ...
        <p class="text-3xl font-bold text-red-600">{{ format_rupiah($grandTotal) }}</p>
    </div>
