            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="flex items-center space-x-3 cursor-pointer">
                        <input type="checkbox" name="is_tingkat_akhir" id="is_tingkat_akhir" value="1" @checked(old('is_tingkat_akhir', $kelas->is_tingkat_akhir)) class="w-5 h-5 text-blue-600 border-2 border-slate-300 rounded focus:ring-blue-500 transition-colors duration-200">
                        <div>
