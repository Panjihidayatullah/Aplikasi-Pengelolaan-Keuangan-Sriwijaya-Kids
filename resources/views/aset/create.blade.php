...
@section('title', 'Tambah Aset - ' . config('app.name'))
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl shadow-lg shadow-slate-200 overflow-hidden">
        ...
        <div class="px-8 py-6 bg-gradient-to-r from-slate-50 to-white border-b border-slate-100">
            <h3 class="text-2xl font-bold text-slate-800">Form Tambah Aset</h3>
            <p class="mt-1 text-sm text-slate-500">Catat aset baru dengan informasi lengkap</p>
        </div>

        <form action="{{ route('aset.store') }}" method="POST" class="p-8">
            @csrf
