            ...
            <div class="hidden lg:flex items-center flex-1 px-4">
                <nav class="flex items-center" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-3">
                        <li>
                            <a href="<?php echo e(route('dashboard')); ?>" class="text-slate-400 hover:text-blue-600 transition-colors">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" 
                        ...
                        <div class="p-4 border-b border-gray-200">
                            ...
                            <p class="text-xs text-gray-500 mt-0.5"><?php echo e($notificationCount); ?> aktivitas terbaru</p>
                            <?php endif; ?>
                        </div>
                        <div class="max-h-96 overflow-y-auto" style="background: #ffffff !important; background-color: #ffffff !important;">
                            <?php if(isset($recentNotifications) && $recentNotifications->count() > 0): ?>
                                ...
                                <a href="<?php echo e($notif['url']); ?>" class="topbar-notif-item block px-4 py-3 hover:bg-gray-50 transition border-l-4 border-transparent hover:border-blue-500" style="background: #ffffff !important; background-color: #ffffff !important;">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0">
                                            <div class="w-10 h-10 rounded-full <?php echo e($notif['icon_bg']); ?> flex items-center justify-center">
                                                <svg class="w-5 h-5 <?php echo e($notif['icon_color']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($notif['icon']); ?>"/>
                                                </svg>
                                            </div>
                                        </div>
                                        <div class="ml-3 flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($notif['title']); ?></p>
                                            <p class="text-xs text-gray-600 mt-0.5 truncate"><?php echo e($notif['description']); ?></p>
                                            <div class="flex items-center justify-between mt-1.5">
                                                <span class="text-xs font-semibold text-blue-600"><?php echo e($notif['amount']); ?></span>
                                                <span class="text-xs text-gray-400"><?php echo e($notif['time']->diffForHumans()); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="p-3 border-t border-gray-200 text-center">
                            <a href="<?php echo e(route('riwayat.index')); ?>" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-700 font-medium">
                ...
                <div x-data="{ open: false }" class="relative">
                    <button @click="open = !open" 
                        ...
                        <div class="hidden md:block text-right">
                            <p class="text-sm font-semibold text-blue-700 group-hover:text-blue-800 transition-colors"><?php echo e(Auth::user()->name ?? 'User'); ?></p>
                            <p class="text-xs text-blue-500"><?php echo e(Auth::user()->email ?? ''); ?></p>
                        </div>
                    ...
                    <div x-show="open" 
                        ...
                        <div class="px-5 py-4 bg-white border-b border-blue-100">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-slate-800"><?php echo e(Auth::user()->name ?? 'User'); ?></p>
                        ...
                        <!-- Menu Items -->
                        <div class="py-2">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center px-5 py-3 text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                            ...
                            <a href="<?php echo e(route('settings.preferences')); ?>" class="flex items-center px-5 py-3 text-sm font-medium text-slate-700 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                                <div class="w-9 h-9 rounded-lg bg-blue-50 group-hover:bg-blue-100 flex items-center justify-center mr-3 transition-colors">
...
<?php /**PATH C:\laragon\www\sriwijaya_kidss\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>