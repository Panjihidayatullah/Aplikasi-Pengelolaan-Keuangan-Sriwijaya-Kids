...
<?php $__env->startSection('welcome-title', 'Selamat Datang Kembali!'); ?>
<?php $__env->startSection('welcome-description', 'Masuk ke sistem untuk mengelola keuangan sekolah dengan mudah dan efisien.'); ?>
...
<div>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5" autocomplete="off">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between">
            ...
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors">
                    Lupa password?
                </a>
            <?php endif; ?>
        </div>
        ...
        <div class="pt-2 text-center space-y-2">
            <?php if(Route::has('register')): ?>
                <p class="text-sm text-slate-600">
                    Belum punya akun?
                    <a href="<?php echo e(route('register')); ?>" class="font-semibold text-blue-600 hover:text-blue-700 transition-colors">Daftar Akun</a>
                </p>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sriwijaya_kidss\resources\views/auth/login.blade.php ENDPATH**/ ?>