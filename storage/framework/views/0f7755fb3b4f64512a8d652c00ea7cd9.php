...
<div class="dash-welcome relative overflow-hidden bg-gradient-to-br from-blue-600 via-cyan-500 to-blue-700 rounded-2xl shadow-2xl shadow-blue-500/30 p-6 mb-6">
    ...
    <div class="relative flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-white mb-1">Selamat Datang, <?php echo e(Auth::user()->name); ?>! 👋</h1>
            <p class="text-blue-100 text-sm"><?php echo e($dashboardSubtitle ?? (config('finance.school.name', 'Educlass') . ' - Dashboard Terpadu Akademik, LMS, dan Keuangan')); ?></p>
        </div>
        <div class="hidden md:flex items-center space-x-3">
            <div class="bg-white/20 backdrop-blur-sm rounded-2xl px-5 py-3 text-white">
                ...
                <p class="text-lg font-bold"><?php echo e(config('finance.defaults.academic_year', '2025/2026')); ?></p>
            </div>
        </div>
    </div>
</div>

<?php if(($dashboardRole ?? 'default') === 'guru'): ?>
    <?php echo $__env->make('dashboard.partials.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php elseif(($dashboardRole ?? 'default') === 'siswa'): ?>
    <?php echo $__env->make('dashboard.partials.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php else: ?>
<?php
...
<div class="dash-module-grid grid grid-cols-1 gap-5 mb-6 <?php echo e(($dashboardRole ?? 'default') === 'bendahara' ? '' : 'lg:grid-cols-12'); ?>">
    <?php if(($dashboardRole ?? 'default') !== 'bendahara'): ?>
    <div class="dash-module-card rounded-2xl shadow-lg shadow-blue-100/70 p-5 border border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 <?php echo e(($dashboardRole ?? 'default') === 'bendahara' ? '' : 'lg:col-span-3'); ?>">
        ...
        <div class="space-y-2 text-sm">
            <div class="flex items-center justify-between"><span class="text-blue-700">Total Kelas</span><span class="font-bold text-blue-950"><?php echo e(number_format($totalKelas)); ?></span></div>
            <div class="flex items-center justify-between"><span class="text-blue-700">Jadwal Aktif</span><span class="font-bold text-blue-950"><?php echo e(number_format($totalJadwalAktif)); ?></span></div>
            <div class="flex items-center justify-between"><span class="text-blue-700">Ujian Mendatang</span><span class="font-bold text-blue-950"><?php echo e(number_format($totalUjianMendatang)); ?></span></div>
        </div>
        <div class="mt-4 pt-4 border-t border-blue-200 flex flex-wrap gap-2">
            <?php if($canViewJadwal): ?>
            <a href="<?php echo e(route('akademik.jadwal-pelajaran.index')); ?>" class="px-3 py-1.5 text-xs font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">Jadwal</a>
            <?php endif; ?>
            <?php if($canViewUjian): ?>
            <a href="<?php echo e(route('akademik.ujian.index')); ?>" class="px-3 py-1.5 text-xs font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">Ujian</a>
            <?php endif; ?>
            <?php if($canViewKelas): ?>
            <a href="<?php echo e(route('kelas.index')); ?>" class="px-3 py-1.5 text-xs font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">Kelas</a>
            <?php endif; ?>
            <?php if(!$canViewJadwal && !$canViewUjian && !$canViewKelas): ?>
            <span class="text-xs font-semibold text-slate-500">Akses akademik terbatas</span>
            <?php endif; ?>
        </div>
    </div>

    <div class="dash-module-card rounded-2xl shadow-lg shadow-emerald-100/70 p-5 border border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 <?php echo e(($dashboardRole ?? 'default') === 'bendahara' ? '' : 'lg:col-span-4'); ?>">
        <div class="flex items-center justify-between mb-4">
        ...
        <div class="space-y-2 text-sm">
            <div class="flex items-center justify-between"><span class="text-emerald-700">Materi</span><span class="font-bold text-emerald-950"><?php echo e(number_format($totalMateri)); ?></span></div>
            <div class="flex items-center justify-between"><span class="text-emerald-700">Tugas</span><span class="font-bold text-emerald-950"><?php echo e(number_format($totalTugas)); ?></span></div>
            <div class="flex items-center justify-between"><span class="text-emerald-700">Pengumpulan</span><span class="font-bold text-emerald-950"><?php echo e(number_format($totalPengumpulan)); ?></span></div>
        </div>
        <div class="mt-4 pt-4 border-t border-emerald-200 flex flex-wrap gap-2">
            <?php if($canViewLmsIndex): ?>
            <a href="<?php echo e(route('akademik.lms.index')); ?>" class="mod-overview-btn mod-overview-btn-lms">LMS</a>
            <?php endif; ?>
            <?php if($canViewLmsMateri): ?>
            <a href="<?php echo e(route('akademik.lms.materi.index')); ?>" class="mod-overview-btn mod-overview-btn-lms">Materi</a>
            <?php endif; ?>
            <?php if($canViewLmsTugas): ?>
            <a href="<?php echo e(route('akademik.lms.tugas.index')); ?>" class="mod-overview-btn mod-overview-btn-lms">Tugas</a>
            <?php endif; ?>
            <?php if($canViewLmsMonitoring): ?>
            <a href="<?php echo e(route('akademik.lms.monitoring.index')); ?>" class="mod-overview-btn mod-overview-btn-lms">Monitoring</a>
            <?php endif; ?>
            <?php if(!$canViewLmsIndex && !$canViewLmsMateri && !$canViewLmsTugas && !$canViewLmsMonitoring): ?>
    ...
    <div class="dash-module-card rounded-2xl shadow-lg shadow-amber-100/80 p-5 border border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50 <?php echo e(($dashboardRole ?? 'default') === 'bendahara' ? 'w-full' : 'lg:col-span-5'); ?>">
        <div class="flex items-center justify-between mb-4">
        ...
        <div class="dash-fin-grid grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div class="flex flex-col"><span class="text-amber-800 mb-1">Pemasukan</span><span class="text-lg font-bold text-emerald-700"><?php echo e(format_rupiah($totalPembayaran)); ?></span></div>
            <div class="flex flex-col"><span class="text-amber-800 mb-1">Pengeluaran</span><span class="text-lg font-bold text-rose-700"><?php echo e(format_rupiah($totalPengeluaran)); ?></span></div>
            <div class="flex flex-col"><span class="text-amber-800 mb-1">Total Transaksi</span><span class="text-lg font-bold text-amber-950"><?php echo e(number_format($transaksiKeuanganBulanIni)); ?></span></div>
        </div>
        <div class="mt-4 pt-4 border-t border-amber-200 flex flex-wrap gap-2">
            <?php if($canViewPembayaran && !$isKepalaSekolahRole): ?>
            <a href="<?php echo e(route('pembayaran.index')); ?>" class="mod-overview-btn mod-overview-btn-fin">Daftar Pembayaran</a>
            <?php endif; ?>
            <?php if($canViewPengeluaran && !$isKepalaSekolahRole): ?>
            <a href="<?php echo e(route('pengeluaran.index')); ?>" class="mod-overview-btn mod-overview-btn-fin">Daftar Pengeluaran</a>
            <?php endif; ?>
            <?php if($canViewCashflow && !$isKepalaSekolahRole): ?>
            <a href="<?php echo e(route('laporan.cashflow')); ?>" class="mod-overview-btn mod-overview-btn-fin">Laporan Cashflow</a>
            <?php endif; ?>
            <?php if((!$canViewPembayaran && !$canViewPengeluaran && !$canViewCashflow) || $isKepalaSekolahRole): ?>
        ...
        <div class="relative p-5 h-full flex flex-col justify-between">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold text-white mt-2 mb-1.5"><?php echo e(format_rupiah($saldo)); ?></p>
            ...
            <div class="mt-4 pt-4 border-t border-white/20">
                <?php if($canViewCashflow && !$isKepalaSekolahRole): ?>
                <a href="<?php echo e(route('laporan.cashflow')); ?>" class="flex items-center justify-between text-xs font-semibold text-white hover:text-blue-100 transition-colors group">
    ...
    <div class="dash-stat-card group relative bg-white rounded-2xl shadow-lg shadow-slate-200 overflow-hidden hover:shadow-xl hover:shadow-slate-300 transition-all duration-300 hover:-translate-y-1">
        <div class="p-5 h-full flex flex-col justify-between">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    <?php if(($dashboardRole ?? 'default') === 'bendahara'): ?>
                        ...
                        <p class="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-green-500 bg-clip-text text-transparent mt-2 mb-1.5"><?php echo e(number_format($transaksiKeuanganBulanIni)); ?></p>
                    ...
                    <?php else: ?>
                        ...
                        <p class="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-green-500 bg-clip-text text-transparent mt-2 mb-1.5"><?php echo e($totalSiswa); ?></p>
                        <div class="inline-flex items-center px-2.5 py-0.5 rounded-full bg-emerald-50">
                            <span class="w-1.5 h-1.5 bg-emerald-500 rounded-full mr-1.5 animate-pulse"></span>
            ...
            <div class="mt-4 pt-4 border-t border-slate-100">
                <?php if(($dashboardRole ?? 'default') === 'bendahara'): ?>
                    <a href="<?php echo e(route('riwayat.index')); ?>" class="flex items-center justify-between text-xs font-semibold text-slate-600 hover:text-emerald-600 transition-colors group">
                ...
                <?php else: ?>
                    <?php if($canViewSiswa): ?>
                    <a href="<?php echo e(route('siswa.index')); ?>" class="flex items-center justify-between text-xs font-semibold text-slate-600 hover:text-emerald-600 transition-colors group">
        ...
        <div class="p-5 h-full flex flex-col justify-between">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent mt-2 mb-1.5"><?php echo e(format_rupiah($totalPembayaran)); ?></p>
            ...
            <div class="mt-4 pt-4 border-t border-slate-100">
                <?php if($canViewPembayaran && !$isKepalaSekolahRole): ?>
                <a href="<?php echo e(route('pembayaran.index')); ?>" class="flex items-center justify-between text-xs font-semibold text-slate-600 hover:text-blue-600 transition-colors group">
        ...
        <div class="p-5 h-full flex flex-col justify-between">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-2xl font-bold bg-gradient-to-r from-rose-600 to-red-500 bg-clip-text text-transparent mt-2 mb-1.5"><?php echo e(format_rupiah($totalPengeluaran)); ?></p>
            ...
            <div class="mt-4 pt-4 border-t border-slate-100">
                <?php if($canViewPengeluaran && !$isKepalaSekolahRole): ?>
                <a href="<?php echo e(route('pengeluaran.index')); ?>" class="flex items-center justify-between text-xs font-semibold text-slate-600 hover:text-rose-600 transition-colors group">
                    <span>Lihat Detail</span>
                    <svg class="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
                    </svg>
...
<div class="dash-chart-grid grid grid-cols-1 gap-5 mb-6 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-lg shadow-slate-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-5 gap-3">
            ...
            <form method="GET" action="<?php echo e(route('dashboard')); ?>" class="dash-chart-filter flex flex-col sm:flex-row gap-2" id="chartFilterForm">
                <input type="date" 
                       name="chart_start_date" 
                       value="<?php echo e(request('chart_start_date', now()->subMonths(5)->startOfMonth()->format('Y-m-d'))); ?>"
                ...
                <input type="date" 
                       name="chart_end_date" 
                       value="<?php echo e(request('chart_end_date', now()->endOfMonth()->format('Y-m-d'))); ?>"
                       class="text-xs border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm px-2 py-1.5 bg-slate-50"
                       onchange="this.form.submit()">
            </form>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg shadow-slate-200 p-6">
        ...
        <div class="relative h-56">
            <canvas id="expenseCompositionChart" class="<?php echo e(($expenseComposition ?? collect())->isEmpty() ? 'opacity-20' : ''); ?>"></canvas>
            <?php if(($expenseComposition ?? collect())->isEmpty()): ?>
...
<div class="dash-bottom-grid grid grid-cols-1 gap-5 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-5 py-3 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <?php if($canViewRiwayat): ?>
                <a href="<?php echo e(route('riwayat.index')); ?>" class="text-xs text-indigo-600 hover:text-indigo-700 font-medium">Lihat Semua →</a>
                <?php endif; ?>
            </div>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" data-slider-per-page="10">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php $__empty_1 = true; $__currentLoopData = $filteredTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $tipe = strtolower((string) ($trx['tipe'] ?? ''));
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-900">
                                <?php echo e(!empty($trx['tanggal']) ? \Carbon\Carbon::parse($trx['tanggal'])->format('d M Y') : '-'); ?>

                            </td>
                            <td class="px-4 py-3 text-xs text-gray-900 max-w-xs">
                                <a href="<?php echo e($trx['url'] ?? ($canViewRiwayat ? route('riwayat.index') : '#')); ?>" class="hover:text-indigo-600 transition-colors line-clamp-1">
                                    <?php echo e($trx['deskripsi'] ?? '-'); ?>

                                </a>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <span class="px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($typeClass); ?>"><?php echo e($trx['tipe'] ?? '-'); ?></span>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-xs font-medium <?php echo e($amountClass); ?>">
                                <?php echo e($isPemasukan ? '+' : '-'); ?><?php echo e(format_rupiah((float) ($trx['jumlah'] ?? 0))); ?>

                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <span class="px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($statusClass); ?>"><?php echo e($statusText); ?></span>
                            </td>
                        </tr>
    ...
    <div class="space-y-5">
        ...
        <div class="dash-quick-actions bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            ...
            <div class="space-y-2">
                <?php if(($dashboardRole ?? 'default') === 'bendahara'): ?>
                <a href="<?php echo e(route('gaji-guru.index')); ?>" class="flex items-center justify-between p-2.5 bg-blue-50 hover:bg-blue-100 rounded-lg transition group">
                ...
                <?php if($canCreateSiswa && ($dashboardRole ?? 'default') !== 'bendahara'): ?>
                <a href="<?php echo e(route('siswa.create')); ?>" class="flex items-center justify-between p-2.5 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition group">
                    <div class="flex items-center">
                ...
                <?php if($canCreatePembayaran): ?>
                <a href="<?php echo e(route('pembayaran.create')); ?>" class="flex items-center justify-between p-2.5 bg-green-50 hover:bg-green-100 rounded-lg transition group">
                    <div class="flex items-center">
                ...
                <?php if($canCreatePengeluaran): ?>
                <a href="<?php echo e(route('pengeluaran.create')); ?>" class="flex items-center justify-between p-2.5 bg-red-50 hover:bg-red-100 rounded-lg transition group">
                    <div class="flex items-center">
                ...
                <?php if($canViewCashflow): ?>
                <a href="<?php echo e(route('laporan.cashflow')); ?>" class="flex items-center justify-between p-2.5 bg-purple-50 hover:bg-purple-100 rounded-lg transition group">
                    <div class="flex items-center">
                ...
                <?php if(!$canCreateSiswa && !$canCreatePembayaran && !$canCreatePengeluaran && !$canViewCashflow && ($dashboardRole ?? 'default') !== 'bendahara'): ?>
        ...
        <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-sm p-5 text-white">
            ...
            <div class="space-y-1.5 text-xs">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold"><?php echo e(strtoupper((string) config('database.default', '-'))); ?></span>
                </div>
                <div class="flex justify-between">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctx) {
        const pemasukanData = <?php echo json_encode($pemasukanData ?? [], 15, 512) ?>;
        const pengeluaranData = <?php echo json_encode($pengeluaranData ?? [], 15, 512) ?>;
        const groupBy = <?php echo json_encode($groupBy ?? 'month', 15, 512) ?>;
    ...
    if (expenseCtx) {
        const expenseComposition = <?php echo json_encode($expenseComposition ?? [], 15, 512) ?>;
    ...
    if (guruTrendCtx) {
        const labels = <?php echo json_encode($guruMonthlyLabels ?? [], 15, 512) ?>;
        const tugasValues = <?php echo json_encode($guruMonthlyTugas ?? [], 15, 512) ?>;
        const pengumpulanValues = <?php echo json_encode($guruMonthlyPengumpulan ?? [], 15, 512) ?>;
    ...
    if (guruStatusCtx) {
        const labels = <?php echo json_encode($guruStatusLabels ?? [], 15, 512) ?>;
        const values = <?php echo json_encode($guruStatusValues ?? [], 15, 512) ?>;
    ...
    if (siswaJadwalCtx) {
        const labels = <?php echo json_encode($siswaScheduleLabels ?? [], 15, 512) ?>;
        const values = <?php echo json_encode($siswaScheduleValues ?? [], 15, 512) ?>;
    ...
    if (siswaProgressCtx) {
        const rawLabels = <?php echo json_encode($siswaProgressLabels ?? [], 15, 512) ?>;
        const rawValues = <?php echo json_encode($siswaProgressValues ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sriwijaya_kidss\resources\views/dashboard/index.blade.php ENDPATH**/ ?>