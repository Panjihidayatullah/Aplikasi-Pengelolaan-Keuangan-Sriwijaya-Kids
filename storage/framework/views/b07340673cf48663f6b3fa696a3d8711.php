...
<?php $__env->startSection('title', 'Data Siswa - ' . config('app.name')); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 flex justify-between items-center">
            ...
            <a href="<?php echo e(route('siswa.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                + Tambah Siswa
            </a>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('siswa.index')); ?>" class="space-y-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <?php if(request()->hasAny(['search', 'kelas_id', 'jenis_kelamin', 'status'])): ?>
                        <span class="text-sm text-gray-600">
                            <strong><?php echo e($siswa->total()); ?></strong> hasil ditemukan
                        </span>
                    <?php endif; ?>
                </div>
            </form>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($s->nis); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($s->nama); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($s->kelas->nama_kelas ?? '-'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($s->jenis_kelamin == 'L' ? 'Laki-laki' : 'Perempuan'); ?></td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($s->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e($s->is_active ? 'Aktif' : 'Tidak Aktif'); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                    <a href="<?php echo e(route('siswa.show', $s->id)); ?>" class="text-indigo-600 hover:text-indigo-900">Detail</a>
                                    <a href="<?php echo e(route('siswa.edit', $s->id)); ?>" class="text-yellow-600 hover:text-yellow-900">Edit</a>
                                    <form action="<?php echo e(route('siswa.destroy', $s->id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sriwijaya_kidss\resources\views/students/index.blade.php ENDPATH**/ ?>